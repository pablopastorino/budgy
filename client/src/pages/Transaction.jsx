...
const TransactionForm = () => {
  ...
  return (
    ...
    >
      <h3 className='font-extrabold sm:text-4xl text-3xl my-4 wrap text-center'>Add Transaction</h3>
      ...
      {error && (
        <div className='text-white bg-gray-900 px-2 rounded-md font-medium mt-4'>{error}</div>
      )}
